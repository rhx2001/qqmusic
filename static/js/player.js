...
var info = JSON.parse(document.getElementById('audio').getAttribute('data-data'))
var songs = [];
var singer = [];
var listname;
// console.log(info)
...
var now_song = document.getElementById("song_name").textContent.substring(4)
// 音乐信息
// const songs = ["打上花火", "Mojito", "Super_Star", "离人"]
// 默认从第一首开始
let songIndex = info[now_song].number;
console.log(songs)
// 将歌曲细节加载到DOM
...
function loadSong(song) {
    ...
    audio.src = `/static/music/${song}.mp3`;      // 路径为 music/打上花火.mp3
